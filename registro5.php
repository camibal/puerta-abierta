...
//conexión db
 //validacion
 if($_POST['texto'] == ''){
    echo "<body class='imagen_fondo_body'><fieldset><div class='padding_fieldset'><p class='titulo'>$titulo</p><br><a href='palabra_riesgo.php' class='btn_a'>OK</a></div></fieldset></body>";
}
//validacion
    //insert db
    if(isset($_POST['texto'])){
        ...
        $sql = "INSERT INTO palabra_riesgo(texto3)
        VALUES('$texto')";
        
        if($conexion->query($sql) === true){
            echo '<script type="text/javascript">
            window.location.assign("opcion_ante_baja.php");
            </script>';
        }
        else{
