...
//conexión db
 //validacion
 if($_POST['texto'] == ''){
    echo "<body class='imagen_fondo_body'><fieldset><div class='padding_fieldset'><p class='titulo'>$titulo</p><br><a href='proporcion_invertir.php' class='btn_a'>OK</a></div></fieldset></body>";
}
//validacion
    //insert db
    if(isset($_POST['texto'])){
        ...
        $sql = "INSERT INTO proporcion_invertir(texto6)
        VALUES('$texto')";
        
        if($conexion->query($sql) === true){
             echo '<script type="text/javascript">
                window.location.assign("empieza.php");
                </script>';
        }
        else{
