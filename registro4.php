...
<?php
       ...
       //conexión db
         //validacion
         if($_POST['texto'] == ''){
            echo "<body class='imagen_fondo_body'><fieldset><div class='padding_fieldset'><p class='titulo'>$titulo</p><br><a href='nivel_ingreso_mensual.php' class='btn_a'>OK</a></div></fieldset></body>";
        }
        //validacion
    //insert db
    if(isset($_POST['texto'])){
        ...
        $sql = "INSERT INTO nivel_ingreso_mensual(texto2)
        VALUES('$texto')";
        
        if($conexion->query($sql) === true){
            echo '<script type="text/javascript">
            window.location.assign("palabra_riesgo.php");
            </script>';
        }
        else{
